...
6. **Ensure file names and directories are listed alphabetically** in sections like "Key Scripts" or "Usage Examples", similar to "Code Structure" above and "Scripts Directory" below.
